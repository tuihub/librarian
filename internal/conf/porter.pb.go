...
func (x *Porter_Data_Steam) Reset() {
	*x = Porter_Data_Steam{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conf_porter_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_conf_porter_proto_rawDesc = []byte{
	...
	0x98, 0x04, 0x0a, 0x06, 0x50, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x12, 0x31, 0x0a, 0x06, 0x73, 0x65,
	...
	,
	...
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x5f, 0x73, 0x73, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x53, 0x73, 0x6c, 0x1a, 0x20, 0x0a, 0x05, 0x53, 0x74, 0x65, 0x61,
	0x6d, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x69, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x42, 0x1e, 0x5a, 0x1c, 0x4c, 0x69,
...
var file_conf_porter_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_conf_porter_proto_goTypes = []interface{}{
	...
	(*Porter_Data_S3)(nil),      // 4: kratos.api.Porter.Data.S3
	(*Porter_Data_Steam)(nil),   // 5: kratos.api.Porter.Data.Steam
...
var file_conf_porter_proto_depIdxs = []int32{
	...
	4, // 3: kratos.api.Porter.Data.s3:type_name -> kratos.api.Porter.Data.S3
	5, // 4: kratos.api.Porter.Data.steam:type_name -> kratos.api.Porter.Data.Steam
	6, // 5: kratos.api.Porter.Server.GRPC.timeout:type_name -> google.protobuf.Duration
...
func file_conf_porter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_porter_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
