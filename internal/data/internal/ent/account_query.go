...
func (_q *AccountQuery) FirstID(ctx context.Context) (id model.InternalID, err error) {
...
func (_q *AccountQuery) FirstIDX(ctx context.Context) model.InternalID {
...
func (_q *AccountQuery) OnlyID(ctx context.Context) (id model.InternalID, err error) {
	var ids []model.InternalID
...
func (_q *AccountQuery) OnlyIDX(ctx context.Context) model.InternalID {
...
func (_q *AccountQuery) IDs(ctx context.Context) (ids []model.InternalID, err error) {
...
func (_q *AccountQuery) IDsX(ctx context.Context) []model.InternalID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
