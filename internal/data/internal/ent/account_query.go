...
func (aq *AccountQuery) QueryBoundUser() *UserQuery {
...
func (aq *AccountQuery) Clone() *AccountQuery {
	...
	return &AccountQuery{
		...
		withBoundUser: aq.withBoundUser.Clone(),
...
func (aq *AccountQuery) WithBoundUser(opts ...func(*UserQuery)) *AccountQuery {
	query := (&UserClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withBoundUser = query
	return aq
}
...
func (aq *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := aq.withBoundUser; query != nil {
		if err := aq.loadBoundUser(ctx, query, nodes, nil,
...
func (aq *AccountQuery) loadBoundUser(ctx context.Context, query *UserQuery, nodes []*Account, init func(*Account), assign func(*Account, *User)) error {
