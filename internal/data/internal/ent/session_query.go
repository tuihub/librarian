...
func (_q *SessionQuery) FirstID(ctx context.Context) (id model.InternalID, err error) {
...
func (_q *SessionQuery) FirstIDX(ctx context.Context) model.InternalID {
...
func (_q *SessionQuery) OnlyID(ctx context.Context) (id model.InternalID, err error) {
	var ids []model.InternalID
...
func (_q *SessionQuery) OnlyIDX(ctx context.Context) model.InternalID {
...
func (_q *SessionQuery) IDs(ctx context.Context) (ids []model.InternalID, err error) {
...
func (_q *SessionQuery) IDsX(ctx context.Context) []model.InternalID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SessionQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Session, init func(*Session), assign func(*Session, *User)) error {
	...
	nodeids := make(map[model.InternalID][]*Session)
	for i := range nodes {
		fk := nodes[i].UserID
