...
func (sq *SessionQuery) FirstID(ctx context.Context) (id model.InternalID, err error) {
...
func (sq *SessionQuery) FirstIDX(ctx context.Context) model.InternalID {
...
func (sq *SessionQuery) OnlyID(ctx context.Context) (id model.InternalID, err error) {
	var ids []model.InternalID
...
func (sq *SessionQuery) OnlyIDX(ctx context.Context) model.InternalID {
...
func (sq *SessionQuery) IDs(ctx context.Context) (ids []model.InternalID, err error) {
...
func (sq *SessionQuery) IDsX(ctx context.Context) []model.InternalID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
