...
func (_q *FileQuery) QueryImage() *ImageQuery {
...
func (_q *FileQuery) FirstID(ctx context.Context) (id model.InternalID, err error) {
...
func (_q *FileQuery) FirstIDX(ctx context.Context) model.InternalID {
...
func (_q *FileQuery) OnlyID(ctx context.Context) (id model.InternalID, err error) {
	var ids []model.InternalID
...
func (_q *FileQuery) OnlyIDX(ctx context.Context) model.InternalID {
...
func (_q *FileQuery) IDs(ctx context.Context) (ids []model.InternalID, err error) {
...
func (_q *FileQuery) IDsX(ctx context.Context) []model.InternalID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *FileQuery) WithImage(opts ...func(*ImageQuery)) *FileQuery {
	query := (&ImageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *FileQuery) loadImage(ctx context.Context, query *ImageQuery, nodes []*File, init func(*File), assign func(*File, *Image)) error {
