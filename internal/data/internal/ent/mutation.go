...
func (m *KVMutation) SetBucket(s string) {
	m.bucket = &s
}

// Bucket returns the value of the "bucket" field in the mutation.
func (m *KVMutation) Bucket() (r string, exists bool) {
	v := m.bucket
	if v == nil {
		return
	}
...
// OldBucket returns the old "bucket" field's value of the KV entity.
// If the KV object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *KVMutation) OldBucket(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *KVMutation) Fields() []string {
	fields := make([]string, 0, 5)
	if m.bucket != nil {
		fields = append(fields, kv.FieldBucket)
	}
	if m.key != nil {
