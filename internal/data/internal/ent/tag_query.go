...
func (_q *TagQuery) FirstID(ctx context.Context) (id model.InternalID, err error) {
...
func (_q *TagQuery) FirstIDX(ctx context.Context) model.InternalID {
...
func (_q *TagQuery) OnlyID(ctx context.Context) (id model.InternalID, err error) {
	var ids []model.InternalID
...
func (_q *TagQuery) OnlyIDX(ctx context.Context) model.InternalID {
...
func (_q *TagQuery) IDs(ctx context.Context) (ids []model.InternalID, err error) {
...
func (_q *TagQuery) IDsX(ctx context.Context) []model.InternalID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
