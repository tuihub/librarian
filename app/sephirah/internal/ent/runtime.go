...
func init() {
	...
	apppackageDescUpdatedAt := apppackageFields[8].Descriptor()
	...
	feedconfigDescUpdatedAt := feedconfigFields[6].Descriptor()
	...
	feedconfigDescCreatedAt := feedconfigFields[7].Descriptor()
