...
func init() {
	...
	feedconfigDescLatestPullAt := feedconfigFields[8].Descriptor()
	...
	feedconfigDescNextPullBeginAt := feedconfigFields[9].Descriptor()
	...
	feedconfigDescUpdatedAt := feedconfigFields[10].Descriptor()
	...
	feedconfigDescCreatedAt := feedconfigFields[11].Descriptor()
	...
	feeditemDescUpdatedAt := feeditemFields[17].Descriptor()
	...
	feeditemDescCreatedAt := feeditemFields[18].Descriptor()
