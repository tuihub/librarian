...
func init() {
	...
	feedconfigDescNextPullBeginAt := feedconfigFields[10].Descriptor()
	...
	feedconfigDescUpdatedAt := feedconfigFields[11].Descriptor()
	...
	feedconfigDescCreatedAt := feedconfigFields[12].Descriptor()
