...
func (tq *TagQuery) FirstID(ctx context.Context) (id model.InternalID, err error) {
...
func (tq *TagQuery) FirstIDX(ctx context.Context) model.InternalID {
...
func (tq *TagQuery) OnlyID(ctx context.Context) (id model.InternalID, err error) {
	var ids []model.InternalID
...
func (tq *TagQuery) OnlyIDX(ctx context.Context) model.InternalID {
...
func (tq *TagQuery) IDs(ctx context.Context) (ids []model.InternalID, err error) {
...
func (tq *TagQuery) IDsX(ctx context.Context) []model.InternalID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tq *TagQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *User)) error {
	...
	nodeids := make(map[model.InternalID][]*Tag)
	for i := range nodes {
		fk := nodes[i].UserTag
...
func (tq *TagQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := tq.ctx.Fields; len(fields) > 0 {
		...
		if tq.withOwner != nil {
			_spec.Node.AddColumnOnce(tag.FieldUserTag)
		}
	}
