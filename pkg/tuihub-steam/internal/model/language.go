...
// LanguageCode https://partner.steamgames.com/doc/store/localization
...
var LanguageCodes = []LanguageCode{ //nolint:gochecknoglobals //TODO
	LanguageArabic, LanguageBulgarian, LanguageChineseSimplified, LanguageChineseTraditional, LanguageCzech,
	LanguageDanish, LanguageDutch, LanguageEnglish, LanguageFinnish, LanguageFrench, LanguageGerman, LanguageGreek,
	LanguageHungarian, LanguageItalian, LanguageJapanese, LanguageKorean, LanguageNorwegian, LanguagePolish,
	LanguagePortuguese, LanguagePortugueseBrazil, LanguageRomanian, LanguageRussian, LanguageSpanishSpain,
...
var Languages = []Language{ //nolint:gochecknoglobals //TODO
	{
		EnglishName:        "Arabic",
		NativeName:         "العربية",
...
// CurrencyCode https://partner.steamgames.com/doc/store/pricing/currencies
...
var Currencies = []Currency{ //nolint:gochecknoglobals //TODO
...
// ProductCC Country codes to get info on apps/packages.
...
var ProductCCs = []ProductCC{ //nolint:gochecknoglobals //TODO
	ProductCCAE, ProductCCAR, ProductCCAU, ProductCCAZ, ProductCCBR, ProductCCCA, ProductCCCH, ProductCCCL, ProductCCCN,
	ProductCCCO, ProductCCCR, ProductCCEU, ProductCCHK, ProductCCID, ProductCCIL, ProductCCIN, ProductCCJP, ProductCCKR,
	ProductCCKW, ProductCCKZ, ProductCCMX, ProductCCMY, ProductCCNO, ProductCCNZ, ProductCCPE, ProductCCPH, ProductCCPK,
	ProductCCPL, ProductCCQA, ProductCCRU, ProductCCSA, ProductCCSG, ProductCCTH, ProductCCTR, ProductCCTW, ProductCCUA,
	ProductCCUK, ProductCCUS, ProductCCUY, ProductCCVN, ProductCCZA,
}
